...
<div class="container">
    <div class="mainbox nomargin">
        ...
        <h3 class="marginbot">
            ...
            <a  href="javascript:void(0);" class="">链接</a>

        </h3>

        <div class="note fixwidthdec">
            <p class="i">这是一资源链接管理模块。</p>
        </div>
        ...
        <form action="<?php echo ($url); ?>" method="post" enctype="multipart/form-data" name="form1">
            ...
            <table class="inputlist">
                ...
                <tr><td class="form_left_space">跳转URL</td><td class="form_right_space"><label><input name="url" type="text" id="url" value="<?php echo ($data["url"]); ?>" class="txt" style="width:300px; height:18px;"></label></td><td>&nbsp;&nbsp;请输入一个完整的网址&nbsp;&nbsp;</td></tr>
            ...
            <div class="opt">
                ...
                <input name="type" type="hidden" id="module" value="url">
