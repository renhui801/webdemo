...
<div class="container">
    <div class="mainbox nomargin">
        ...
        <h3 class="marginbot">
            ...
            选择栏目模型：<a type="" href="javascript:void(0);" class="">单页</a>
            ...
            <a <?php echo ($hidden); ?> href="<?php echo ($add["product"]); ?>&id=<?php echo ($get["id"]); ?>&parentId=<?php echo ($get["parentId"]); ?>&level=<?php echo ($get["level"]); ?>" class="sgbtn">产品</a>
        ...
        <form action="<?php echo ($url); ?>" method="post" enctype="multipart/form-data" name="form1">
            ...
            <table class="inputlist">
                ...
                <tr><td class="form_left_space">分类排序ID</td><td class="form_right_space"><label><input name="sort" type="text" id="sortid" value="<?php echo ($data["sort"]); ?>" class="txt" style="width:300px; height:18px;"></label></td><td>&nbsp;&nbsp;分类排序ID，产品分类从小到大排序&nbsp;&nbsp;</td></tr>
            ...
            <div class="opt">
                ...
                <input name="type" type="hidden" id="module" value="page">
