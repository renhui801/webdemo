...
<div class="container">
    ...
    <h3 class="marginbot">
        ...
        <a href="<?php echo ($addproduct); ?>" class="sgbtn"><span>添加产品</span></a>
        <a onClick="return confirm('此操作需要几分钟或更长时间，确定要进行吗？')"  href="xsite.php?action=product&operation=update_index&category=p1" class="sgbtn"><span>更新该栏索引</span></a>
    </h3>
    ...
    <div class="mainbox">
        <form id="postform" name="postform" method="post" action="<?php echo ($ProductListEdit); ?>">
            <table class="inputlist">
                <tr>
                    <th><label><input class="checkbox" type="checkbox" id="chkall" name="chkall" onClick="checkall(this.form);" /></label></th>		  <th nowrap="nowrap">标题</th>
            ...
            <label><input name="category" type="hidden" value="<?php echo ($category); ?>">
